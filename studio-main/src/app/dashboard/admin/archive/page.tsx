  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="border-none shadow-xl border-l-4 border-l-blue-500 bg-white rounded-[2rem]">
        ...
        <Card className="border-none shadow-xl border-l-4 border-l-accent bg-white rounded-[2rem]">
